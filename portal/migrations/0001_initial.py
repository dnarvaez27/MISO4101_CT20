# Generated by Django 3.1.6 on 2021-02-08 02:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peso',
                 models.FloatField(help_text='Peso del Deportista',
                                   validators=[django.core.validators.MinValueValidator(0.0)])),
                ('estatura',
                 models.FloatField(help_text='Estatura del Deportista',
                                   validators=[django.core.validators.MinValueValidator(0.0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deporte_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='portal.deporte')),
                ('deportista_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                    to='portal.deportista')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participacion',
                 models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='portal.participacion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuarioId',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='portal.usuarioregistrado')),
                ('videoId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='portal.video')),
            ],
            options={
